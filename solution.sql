...
-- 6. Get the Username and account balances of the 3 users with the lowest
-- balances, sort lowest to highest balance.
SELECT username, account_balance
FROM syntax_practice
ORDER BY account_balance ASC
LIMIT 3; --This is excluding Anthony, who had no account balance until task 3 :)
...
VALUES ('Casey', 'Minneapolis', 0, 0, 666);

-- 9. The bank is losing money in Miami and Phoenix and needs to unload low
-- transaction customers: Delete users that reside in Miami OR Pheonix and have
